...
latest_posts: false # MPMD was true  # includes a list of the newest posts
selected_papers: false # MPMD was true # includes a list of papers marked as "selected={true}"
